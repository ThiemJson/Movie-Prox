...
struct Constant {
    struct Ads {
#if Develop
        static let ads_openapp      = "ca-app-pub-3940256099942544/5662855259"
        static let ads_banners      = "ca-app-pub-3940256099942544/2934735716"
        static let ads_interstitial = "ca-app-pub-3940256099942544/4411468910"
        static let ads_rewarded     = "ca-app-pub-3940256099942544/1712485313"
        static let ads_native       = "ca-app-pub-3940256099942544/2247696110"
#elseif Staging
        static let ads_openapp      = "ca-app-pub-3940256099942544/5662855259"
        static let ads_banners      = "ca-app-pub-3940256099942544/2934735716"
        static let ads_interstitial = "ca-app-pub-3940256099942544/4411468910"
    ...
    static let selfieFrames = [Constant.Frame.frame1,
                               Constant.Frame.frame2,
                               Constant.Frame.frame3,
                               Constant.Frame.frame4,
                               Constant.Frame.frame5]
    
    static let demoSelfieFrames = [Constant.Frame.demo_frame1,
                                   Constant.Frame.demo_frame2,
                                   Constant.Frame.demo_frame3,
                                   Constant.Frame.demo_frame4,
                                   Constant.Frame.demo_frame5]
    
    static let selfiePosters = [Constant.Frame.poster_frame1,
                                Constant.Frame.poster_frame2,
                                Constant.Frame.poster_frame3,
                                Constant.Frame.poster_frame4,
                                Constant.Frame.poster_frame5]
    struct Frame {
        static let frame1   = "ic_frame_01"
        static let frame2   = "ic_frame_02"
        static let frame3   = "ic_frame_03"
        static let frame4   = "ic_frame_04"
        static let frame5   = "ic_frame_05"
        
        static let demo_frame1   = "ic_frame_01_demo"
        static let demo_frame2   = "ic_frame_02_demo"
        static let demo_frame3   = "ic_frame_03_demo"
        static let demo_frame4   = "ic_frame_04_demo"
        static let demo_frame5   = "ic_frame_05_demo"
        
        static let poster_frame1    = "ic_frame_poster_01"
        static let poster_frame2    = "ic_frame_poster_02"
        static let poster_frame3    = "ic_frame_poster_03"
        static let poster_frame4    = "ic_frame_poster_04"
        static let poster_frame5    = "ic_frame_poster_05"
    }
    
    static let MonthMapper = [(1,"January"),
    ...
    struct NotificationCenter {
        ...
        struct Name {
            static let trackingTypeChange = "trackingTypeChange"
        }
    }
    
    struct Values {
        static let currentTimeZone = "Asia/Ho_Chi_Minh"
        static let commonRadius = 8
    }
    ...
    struct Color {
        ...
        static let tabar_unselected = UIColor(red: 158/255, green: 182/255, blue: 195/255, alpha: 0.5)
