...
class BaseLoading {
    ...
    func show(forView view: UIView? = nil, message: String? = "Loading ...", style: UIActivityIndicatorView.Style = .whiteLarge, tintColor: UIColor = .white) {
        ...
        messageView.textColor = tintColor
        messageView.textAlignment = .center
        messageView.numberOfLines = 0
        messageView.text = message ?? "Loading ..."
