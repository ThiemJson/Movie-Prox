        ...
        didSet {
            DispatchQueue.main.async {
                self.viewControllers.forEach { vc in
                    guard let contentInset = self.contentInset else { return }
                    
                    //                    if let movie = vc as? FvPageMovieVC {
                    //                        movie.contentInset  = contentInset
                    //                    }
                    //
                    //                    if let actor = vc as? FVPageActorVC {
                    //                        actor.contentInset  = contentInset
                    //                    }
                    //
                    //                    if let tvshow = vc as? FVPageTVShowVC {
                    //                        tvshow.contentInset = contentInset
                    //                    }
                }
            }
        }
